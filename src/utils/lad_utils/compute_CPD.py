...
def find_factors_UCI():
    ...
    lad_util.save_object(factors, tname)
...
def find_synthetic_factors(fname):
    ...
    print(datetime.datetime.now())
    factors = apply_parafac(T, dimension=dim)
    lad_util.save_object(factors, "SBM_factors" + str(dim) + ".pkl")
    print(datetime.datetime.now())
    print("CPD ends")

    # factors = lad_util.load_object("SBM_factors30.pkl")
...
def find_UCI_factors():
    ...
    print(datetime.datetime.now())
    factors = apply_parafac(T, dimension=dim)
    lad_util.save_object(factors, "UCI_factors" + str(dim) + ".pkl")
    print(datetime.datetime.now())
    print("CPD ends")
    # factors = lad_util.load_object("UCI_factors1000.pkl")
...
def find_USLegis_factors():
    ...
    print(datetime.datetime.now())
    print("CPD ends")
    lad_util.save_object(factors, "USLegis_factors" + str(dim) + ".pkl")
...
def find_canVote_factors():
    ...
    print(datetime.datetime.now())
    print("CPD ends")
    lad_util.save_object(factors, "canVote_factors" + str(dim) + ".pkl")
